...
def getConstructionData(bjdongCd, pageNo, numOfRows):
    ...
    parameters += "&sigunguCd=" + str(11650)
...
def getprocessedData(Cd=None):
    ...
    for i in bjdongCd:
        ...
        while(True):
            ...
            xmlData = getConstructionData(bjdongCd, pageNo, numOfRows)
            print(xmlData)
