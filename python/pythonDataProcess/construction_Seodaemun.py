...
def getConstructionData(pageNo, numOfRows):
    ...
    parameters += "&sigunguCd=" + str(11410)
...
dataList = []
bjdongCd = [10100,10200,10300,10400,10500,10600,10700,10800,10900,11000,11100,11200,11300,11400,11500,11600,11700,11800,11900,12000]
...
savedFilename = 'newSeodaemoon'+str(bjdongCd)+'.csv'
