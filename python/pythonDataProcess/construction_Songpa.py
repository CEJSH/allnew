...
def getConstructionData(pageNo, numOfRows):
    ...
    parameters += "&sigunguCd=" + str(11710)
...
bjdongCd = [10100,10200,10300,10400,10500,10600,10700,10800,10900,11100,11200,11300,11400]
...
savedFilename = 'newSongpa'+str(bjdongCd)+'.csv'
