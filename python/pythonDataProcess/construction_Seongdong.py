...
def getConstructionData(pageNo, numOfRows):
    ...
    parameters += "&sigunguCd=" + str(11200)
...
dataList = []
bjdongCd = [10100,10200,10300,10400,10500,10600,10700,10800,10900,11000,11100,11200,11300,11400,11500,11800,12200]
...
savedFilename = 'newSeongdong'+str(bjdongCd)+'.csv'
