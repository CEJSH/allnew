# originCd = [10100,10200,10300,10400,10500,10600,10700,10800,10900,11000]
...
def getConstructionData(pageNo, numOfRows):
    ...
    parameters += "&sigunguCd=" + str(11230)
...
dataList = []
bjdongCd = [10100,10200,10300,10400,10500,10600,10700,10800,10900,11000]
...
savedFilename = 'newDongdaemoon'+str(bjdongCd)+'.csv'
